<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="GestionDeRecurso.aspx.cs" Inherits="IPC2Proyecto.PaginasAdmin.GestionDeRecurso" %>
...
WHERE id_actividad = @id" InsertCommand="INSERT INTO Actividad( nombre, fecha_incio, tipo, presentacion, fecha_final, cuestionario, codigo_qr, carta_id_carta, salon_id_salon, curso_id_curso) VALUES (@nombre, @fecha_incio, @tipo, @presentacion, @fecha_final, @cuestionario, @codigo_qr, @carta_id_carta, @salon_id_salon, @curso_id_curso)" SelectCommand="SELECT [id_actividad] AS id, [nombre], [fecha_incio], [fecha_final], [tipo], [presentacion], [cuestionario], [codigo_qr], [salon_id_salon], [carta_id_carta], [curso_id_curso] FROM [Actividad]" UpdateCommand="UPDATE Actividad SET nombre = @nombre, tipo = @tipo, fecha_incio = @fecha_incio, presentacion = @presentacion, fecha_final = @fecha_final, cuestionario = @cuestionario, codigo_qr = @codigo_qr, carta_id_carta = @carta_id_carta, salon_id_salon = @salon_id_salon, curso_id_curso = @curso_id_curso WHERE (id_actividad = @id)">
                ...
                <asp:View ID="View2" runat="server">
                    ...
                    <asp:ListView ID="ListView2" runat="server" DataKeyNames="id" DataSourceID="SqlDataSourceAsignacion" InsertItemPosition="LastItem">
                        <AlternatingItemTemplate>
                            <tr style="background-color: #FFFFFF;color: #284775;">
                                <td>
                                    <asp:Button ID="DeleteButton" runat="server" CommandName="Delete" Text="Delete" />
...
WHERE id_asignacion = @id">
                ...
                <asp:View ID="View3" runat="server">
                    ...
                    <asp:ListView ID="ListView12" runat="server" DataKeyNames="id" DataSourceID="SqlDataSourceCarta" InsertItemPosition="LastItem">
                        <AlternatingItemTemplate>
                            <tr style="background-color: #FFFFFF;color: #284775;">
                                <td>
                                    <asp:Button ID="DeleteButton" runat="server" CommandName="Delete" Text="Delete" />
                    ...
                    <asp:SqlDataSource ID="SqlDataSourceCarta" runat="server" ConnectionString="<%$ ConnectionStrings:ModelDatabase1 %>" DeleteCommand="DELETE FROM Carta WHERE (id_carta = @id)" InsertCommand="INSERT INTO Carta(asunto, contenido, usuario_instructor, imagen) VALUES (@asunto, @contenido, @usuario_instructor, @imagen)" SelectCommand="SELECT id_carta AS id, asunto, contenido, usuario_instructor, imagen FROM Carta" UpdateCommand="UPDATE Carta SET asunto = @asunto, contenido = @contenido, usuario_instructor = @usuario_instructor, imagen = @imagen WHERE (id_carta = @id)">
                        <DeleteParameters>
                            <asp:Parameter Name="id" />
                        </DeleteParameters>
                        <InsertParameters>
                ...
                <asp:View ID="View4" runat="server">
                    ...
                    <asp:ListView ID="ListView4" runat="server" DataKeyNames="id" DataSourceID="SqlDataSourceCurso" InsertItemPosition="LastItem">
                        <AlternatingItemTemplate>
                            <tr style="background-color: #FFFFFF;color: #284775;">
                                <td>
                                    <asp:Button ID="DeleteButton" runat="server" CommandName="Delete" Text="Delete" />
                    ...
                    <asp:SqlDataSource ID="SqlDataSourceCurso" runat="server" ConnectionString="<%$ ConnectionStrings:ModelDatabase1 %>" DeleteCommand="DELETE FROM Curso WHERE (id_curso = @id)" InsertCommand="INSERT INTO Curso(nombre, ciclo,fecha_incio,fecha_final) VALUES (@nombre, @ciclo,@fecha_incio,@fecha_final)" SelectCommand="SELECT id_curso AS id, nombre, ciclo, fecha_incio, fecha_final FROM Curso" UpdateCommand="UPDATE Curso SET nombre = @nombre, ciclo = @ciclo, fecha_incio=@fecha_incio,fecha_final=@fecha_final WHERE (id_curso = @id)">
                        <DeleteParameters>
                            <asp:Parameter Name="id" />
                        </DeleteParameters>
                        <InsertParameters>
                ...
                <asp:View ID="View5" runat="server">
                    ...
                    <asp:ListView ID="ListView5" runat="server" DataKeyNames="id" DataSourceID="SqlDataSourceIncidenteInsumo" InsertItemPosition="LastItem">
                        <AlternatingItemTemplate>
                            <tr style="background-color: #FFFFFF;color: #284775;">
                                <td>
                                    <asp:Button ID="DeleteButton" runat="server" CommandName="Delete" Text="Delete" />
                ...
                <asp:View ID="View6" runat="server">
                    ...
                    <asp:ListView ID="ListView6" runat="server" DataKeyNames="id" DataSourceID="SqlDataSourceIncidenteSalon" InsertItemPosition="LastItem">
                        <AlternatingItemTemplate>
                            <tr style="background-color: #FFFFFF;color: #284775;">
                                <td>
                                    <asp:Button ID="DeleteButton" runat="server" CommandName="Delete" Text="Delete" />
...
">
                ...
                <asp:View ID="View8" runat="server">
                    ...
                    <asp:ListView ID="ListView8" runat="server" DataKeyNames="id" DataSourceID="SqlDataSourceMatricula" InsertItemPosition="LastItem">
                        <AlternatingItemTemplate>
                            <tr style="background-color: #FFFFFF;color: #284775;">
                                <td>
                                    <asp:Button ID="DeleteButton" runat="server" CommandName="Delete" Text="Delete" />
                ...
                <asp:View ID="View9" runat="server">
                    ...
                    <asp:ListView ID="ListView9" runat="server" DataKeyNames="id" DataSourceID="SqlDataSourcePrestamo" InsertItemPosition="LastItem">
                        <AlternatingItemTemplate>
                            <tr style="background-color: #FFFFFF;color: #284775;">
                                <td>
                                    <asp:Button ID="DeleteButton" runat="server" CommandName="Delete" Text="Delete" />
...
WHERE id_prestamo = @id">
                ...
                <asp:View ID="View11" runat="server">
                    ...
                    <asp:SqlDataSource ID="SqlDataSourceUsuarios" runat="server" ConnectionString="<%$ ConnectionStrings:ModelDatabase1 %>" DeleteCommand="DELETE FROM Usuario WHERE (id_usuario = @id)" InsertCommand="INSERT INTO Usuario(carne, cui, contrasena, direccion, nombre, telefono, correo, fecha_de_nacimiento, tipo) VALUES (@carne, @cui, @contrasena, @direccion, @nombre, @telefono, @correo, @fecha_de_nacimiento, @tipo)" SelectCommand="SELECT id_usuario AS id, carne, cui, contrasena, nombre, direccion, telefono, correo, fecha_de_nacimiento, tipo FROM Usuario" UpdateCommand="UPDATE Usuario SET carne = @carne, cui = @cui, contrasena = @contrasena, nombre = @nombre, direccion = @direccion, telefono = @telefono, correo = @correo, fecha_de_nacimiento = @fecha_de_nacimiento, tipo = @tipo WHERE (id_usuario = @id)">
                        <DeleteParameters>
                            <asp:Parameter Name="id" />
                        </DeleteParameters>
                        <InsertParameters>
